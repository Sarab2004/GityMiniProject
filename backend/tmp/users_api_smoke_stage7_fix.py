...
c = APIClient()
c.force_login(admin)
# اجباری نیست ولی کمک می‌کند به‌جای testserver از localhost استفاده کند
c.defaults["HTTP_HOST"] = "localhost"

BASE="/api/v1/auth/admin/users/"

u_payload = {
  "username":"u_stage7_fix","password":"StrongPass_1234",
...
# SEARCH
resp_s = c.get(BASE, {"search":"u_stage7_fix"})
